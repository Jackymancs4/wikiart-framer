...
def processImage(filepath, filename):
    ...
    print('Immagine scalata. Larghezza: ' + str(scaled_width) + ' Altezza: ' + str(scaled_height))
    ...
    ScaledBackgroudImage = BackgroudImage.resize((background_scaled_width, background_scaled_height))
    print('Background scalata. Larghezza: ' + str(background_scaled_width) + ' Altezza: ' + str(background_scaled_height))

    if(ScaledBackgroudImage.height < screen_height) or (ScaledBackgroudImage.width < screen_width):
    ...
    print('Background tagliato. Larghezza: ' + str(cutBackgroudImage.width) + ' Altezza: ' + str(cutBackgroudImage.height))
...
def ottieniArte():
    x = requests.get('https://www.wikiart.org/en/App/Painting/random', allow_redirects=False)
    # print(x.status_code)
    # x = "test"
